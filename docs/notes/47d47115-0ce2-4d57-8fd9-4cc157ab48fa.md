...
$\\left(S^{_}=\\frac{j}{(j+p)}, I^_={0}\\right)$
$\\left(S^_=\\frac{g}{a}, I^{_}=\\frac{j-(j+p) \\frac{g}{a}}{(a S+q+j)}\\right)$
...
Steven Strogatz, Nonlinear dynamics and chaos, 2015, _Westview Press_, Boulder Co
...
Kermack McKendrick, Contributions to the mathematical theory of epidemics-I, 1927, _Bulletin of Mathematical Biology_

##### 4

Linda JS Allen, An introduction to stochastic processes with applications to biology, 2003, _Pearson Education_ New Jersey
